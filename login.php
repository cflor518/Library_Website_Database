         ...
         <div class="collapse navbar-collapse" id="navbarSupportedContent">
           ...
           <ul class="navbar-nav">
             <li class="nav-item active">
               <a href="http://localhost:8888/Library_Website_Database-master/libwelcome.php" class="nav-link ac" href=""><p class="a">Home</p></a>
             </li>
             <li class="nav-item">
               <a href="http://localhost:8888/Library_Website_Database-master/login.php" class="nav-link" href=""><p class="a">Login</p></a>
             </li>
             <li class="nav-item">
